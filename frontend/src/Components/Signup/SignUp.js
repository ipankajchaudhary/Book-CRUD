...
const Signup = ({ changeloggedin, changeauthtoken }) => {
        ...
        <div className="signup">
            ...
            <form >
                ...
                <div>
                    ...
                    <input type="text" className="form-control password-input" id="cpassword" name="cpassword"  placeholder="Enter your password again..."  onChange={onChange2} />
